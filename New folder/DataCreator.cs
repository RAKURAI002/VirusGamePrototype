...
public class DataCreator : MonoBehaviour
{
    void Start()
    {
        ...
        void CreateDailyQuestData()
        {
            ...
            System.IO.File.WriteAllText(Application.streamingAssetsPath + "/AchievementData.json", dailyQuestData);
        ...
        void CreateStoryquestData()
        {
            ...
            System.IO.File.WriteAllText(Application.streamingAssetsPath + "/AchievementData.json", storyQuestData);
